...
export default function SettingsPage() {
  ...
  return <>
    ...
    {tab === "CONNECTIONS" ? <section className={styles.connectionGrid}>
      ...
      <ConnectionCard icon={<DatabaseZap />} title="Google Drive" detail="Dépôt des documents corrigés" connected={settings.integrations.googleDrive}><Button variant="secondary" disabled>Configuration Drive</Button><Button variant="ghost" onClick={() => resetConnection("googleDrive")} disabled={Boolean(resettingConnection)}>{resettingConnection === "googleDrive" ? "Réinitialisation…" : "Réinitialiser"}</Button></ConnectionCard>
